    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        dataframe.loc[
            (   
                ...
                & (informativeBTC5M['close'] > informativeBTC1M['BTC_ICH_SSA_5M'])
                & (informativeBTC5M['close'] > informativeBTC1M['BTC_ICH_SSB_5M'])
                & (informativeBTC5M['close'] > informativeBTC1M['BTC_ICH_TS_5M'])
                & (informativeBTC5M['close'] > informativeBTC1M['BTC_ICH_KS_5M'])
