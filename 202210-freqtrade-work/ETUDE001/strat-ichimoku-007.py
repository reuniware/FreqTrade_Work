...
class StratIchimoku006(IStrategy):
    delete_log_results()
    ...
    def populate_indicators(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        inf_tf = '15m'
        informativeBTC15M = self.dp.get_pair_dataframe(pair="BTC/USDT:USDT", timeframe=inf_tf)
        inf_tf = '30m'
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        dataframe.loc[
            (   
                ...
                #& (informative4H['ICH_CS_4H'] > informative4H['ICH_CS_HIGH_4H'])
                #& (informative4H['ICH_CS_4H'] > informative4H['ICH_CS_KS_4H'])
                #& (informative4H['ICH_CS_4H'] > informative4H['ICH_CS_TS_4H'])
                #& (informative4H['ICH_CS_4H'] > informative4H['ICH_CS_SSA_4H'])
                #& (informative4H['ICH_CS_4H'] > informative4H['ICH_CS_SSB_4H'])

                #Conditions for the bitcoin in 15m
                #& (informativeBTC15M['close'] > informativeBTC15M['open'])
                ...
                #& (informativeBTC30M['close'] > informativeBTC30M['open'])
                #& (informativeBTC30M['BTC_ICH_CS_30M'] > informativeBTC30M['BTC_ICH_CS_HIGH_30M'])
                #& (informativeBTC30M['BTC_ICH_CS_30M'] > informativeBTC30M['BTC_ICH_CS_KS_30M'])
                #& (informativeBTC30M['BTC_ICH_CS_30M'] > informativeBTC30M['BTC_ICH_CS_TS_30M'])
                #& (informativeBTC30M['BTC_ICH_CS_30M'] > informativeBTC30M['BTC_ICH_CS_SSA_30M'])
                ...
                #& (informativeBTC1H['close'] > informativeBTC1H['open'])
                ...
                #& (informativeBTC4H['close'] > informativeBTC4H['open'])
        ...
        dataframe.loc[
            (   
                ...
                #& (informative4H['ICH_CS_4H'] < informative4H['ICH_CS_LOW_4H'])
                #& (informative4H['ICH_CS_4H'] < informative4H['ICH_CS_KS_4H'])
                #& (informative4H['ICH_CS_4H'] < informative4H['ICH_CS_TS_4H'])
                #& (informative4H['ICH_CS_4H'] < informative4H['ICH_CS_SSA_4H'])
                #& (informative4H['ICH_CS_4H'] < informative4H['ICH_CS_SSB_4H'])
                ...
                #Conditions for the bitcoin in 15m
                #& (informativeBTC15M['close'] < informativeBTC15M['open'])
                #& (informativeBTC15M['BTC_ICH_CS_15M'] < informativeBTC15M['BTC_ICH_CS_LOW_15M'])
                #& (informativeBTC15M['BTC_ICH_CS_15M'] < informativeBTC15M['BTC_ICH_CS_KS_15M'])
                #& (informativeBTC15M['BTC_ICH_CS_15M'] < informativeBTC15M['BTC_ICH_CS_TS_15M'])
                #& (informativeBTC15M['BTC_ICH_CS_15M'] < informativeBTC15M['BTC_ICH_CS_SSA_15M'])
                #& (informativeBTC15M['BTC_ICH_CS_15M'] < informativeBTC15M['BTC_ICH_CS_SSB_15M'])
